...
namespace ScratchCard.Infrastructure.Migrations
{
    ...
    [Migration("20260703173624_AddShiftAttendanceSubmittedTimes")]
    partial class AddShiftAttendanceSubmittedTimes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.CoinBagAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("CoinDenominationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CurrentBagQuantity")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("ResolvedByTransactionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("StockAlertLimit")
                        .HasColumnType("int");

                    b.Property<Guid?>("TriggeredByTransactionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopId", "CoinDenominationId", "Status");

                    b.ToTable("CoinBagAlerts");
                });

            modelBuilder.Entity("ScratchCard.Domain.Entities.CoinBagAlertRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopId", "CoinDenominationId");

                    b.ToTable("CoinBagAlertRecipients");
                });

            modelBuilder.Entity("ScratchCard.Domain.Entities.CoinBagTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalCoinValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ShopId", "PerformedOn");

                    b.ToTable("CoinBagTransactions");
                });

            modelBuilder.Entity("ScratchCard.Domain.Entities.CoinDenomination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopId", "Name", "IsDeleted")
                        .IsUnique()
                        .HasFilter("[ShopId] IS NOT NULL");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductExpiryAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductExpiryActions");
                });

            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductExpiryReminderRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductExpiryReminderRules");
                });
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.RotaTimesheetLock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ShiftAttendance", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SubmittedCheckInAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("SubmittedCheckOutAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ShopCoinBagConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AlertChannel")
                        .HasColumnType("int");

                    b.Property<int>("AlertRecipientType")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset?>("LastAlertResolvedOn")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("LastAlertTriggeredOn")
                        .HasColumnType("datetimeoffset");

                    b.Property<int>("MaxBagQuantity")
                        .HasColumnType("int");

                    b.Property<int>("MinBagQuantity")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OpeningBagQuantity")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShopId", "CoinDenominationId", "IsDeleted")
                        .IsUnique();

                    b.ToTable("ShopCoinBagConfigs");
                });

            modelBuilder.Entity("ScratchCard.Domain.Entities.ShopCoinBagStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ShopSubscription", b =>
                {
                    ...
                    b.Property<int?>("TrialReminderStage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.StaffLeaveEntitlement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("EntitledHours")
                        .HasPrecision(9, 2)
                    ...
                    b.Property<decimal>("UsualHoursPerDay")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.HasIndex("ShopId", "UserId", "RotaStaffMemberId", "YearStart")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL AND [RotaStaffMemberId] IS NOT NULL");

                    b.ToTable("StaffLeaveEntitlements");
                });
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TemperatureAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("TemperatureEquipmentIssueId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("TemperatureReadingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TemperatureEquipmentIssueId");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TemperatureEquipmentIssue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ApprovalSignatureImagePath")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<bool?>("FoodDiscarded")
                        .HasColumnType("bit");

                    b.Property<bool?>("FoodMoved")
                        .HasColumnType("bit");

                    b.Property<string>("FoodMovedTo")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<DateTimeOffset>("IssueStartedOn")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid?>("MaintenanceByUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset?>("MaintenanceStartedOn")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<bool>("OpenedFromReading")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ResolvedWithWarning")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("TemperatureAtOpenCelsius")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.HasIndex("ShopId", "TemperatureMonitoringUnitId", "Status");

                    b.ToTable("TemperatureEquipmentIssues");
                });
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TemperatureMonitoringUnit", b =>
                {
                    ...
                    b.Property<int>("CurrentWorkingStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TemperatureScheduleUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ScheduleId", "TemperatureMonitoringUnitId")
                        .IsUnique();

                    b.ToTable("TemperatureScheduleUnits");
                });
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TillGroupDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopId", "Code", "IsDeleted")
                        .IsUnique()
                        .HasFilter("[ShopId] IS NOT NULL");

                    b.ToTable("TillGroupDefinitions");
                });
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.CoinBagAlert", b =>
                {
                    b.HasOne("ScratchCard.Domain.Entities.CoinDenomination", "CoinDenomination")
                        .WithMany()
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.LeaveRequest", b =>
                {
                    b.HasOne("ScratchCard.Domain.Entities.User", "DecidedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductBatch", b =>
                {
                    b.HasOne("ScratchCard.Domain.Entities.ProductCategory", "ProductCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.ProductExpiryAction", b =>
                {
                    b.HasOne("ScratchCard.Domain.Entities.ProductBatch", "ProductBatch")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.RotaTimesheetLock", b =>
                {
                    b.HasOne("ScratchCard.Domain.Entities.User", "LockedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ScratchCard.Domain.Entities.TemperatureAttachment", b =>
                {
                    ...
                    b.HasOne("ScratchCard.Domain.Entities.TemperatureEquipmentIssue", "TemperatureEquipmentIssue")
                        .WithMany("Attachments")
                        .HasForeignKey("TemperatureEquipmentIssueId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ScratchCard.Domain.Entities.TemperatureReading", "TemperatureReading")
                        .WithMany("Attachments")
                    ...
                    b.Navigation("TemperatureEquipmentIssue");
