...
const lightColors = {
  ...
  text: "#172033",
  textMuted: "#5C6680",
  // Darkened from #8690A6 to reach WCAG AA (~4.7:1 on white) at the 11-13px sizes it is used for.
  textSubtle: "#656F86",
  textOnDark: "#DCEAF4",
  ...
  textDangerStrong: "#A5182B",
  primary: "#0E7A8A",
  primaryPressed: "#0A5D69",
  onPrimary: "#F2FCFF",
  // "On" colours for text/icons sitting on a filled status background (count badges, banners, filled chips).
  onDanger: "#FFFFFF",
  onWarning: "#3A2600",
  onSuccess: "#FFFFFF",
  onInfo: "#FFFFFF",
...
const darkColors: AppColors = {
  ...
  textDangerStrong: "#F2B0BC",
  primary: "#1FA6B8",
  primaryPressed: "#198A9A",
  onPrimary: "#041418",
  // Tones are lighter in dark mode, so "on" colours are dark ink for legible contrast.
  onDanger: "#3A0810",
  onWarning: "#3A2A00",
  onSuccess: "#04281A",
  onInfo: "#0A1830",
