        ...
        <View style={ui.card}>
          ...
          <View style={styles.metricsRow}>
            <View style={styles.metricCard}>
              <Text style={styles.metricValue}>{totalDays}</Text>
              <Text style={styles.metricLabel}>Days</Text>
            </View>
            <View style={styles.metricCard}>
              <Text style={styles.metricValue}>{totalShifts}</Text>
              <Text style={styles.metricLabel}>Shifts</Text>
            </View>
            <View style={styles.metricCard}>
              <Text style={styles.metricValue}>GBP {totalSales.toFixed(2)}</Text>
              <Text style={styles.metricLabel}>Total Sales</Text>
            </View>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.meta}>Net Difference: GBP {totalDifference.toFixed(2)}</Text>
          </View>
          ...
          {groupedRows.map(([businessDate, rows]) => {
            ...
            return (
              ...
              >
                ...
                <Text style={styles.groupHeaderHint}>Tap date to open Day Management</Text>
                <View style={styles.daySummaryCard}>
                  <Text style={styles.meta}>Day Sales: £ {dayAggregate.totalSales.toFixed(2)}</Text>
                  <Text style={styles.meta}>Day Payout: £ {dayAggregate.totalPayout.toFixed(2)}</Text>
                  <Text style={styles.meta}>Day Expected: £ {dayAggregate.totalExpected.toFixed(2)}</Text>
                  <Text style={styles.meta}>Day Actual: £ {dayAggregate.totalActual.toFixed(2)}</Text>
                  <Text
                    style={[
                      styles.meta,
                  ...
                  >
                    Day Difference: £ {dayAggregate.totalDifference.toFixed(2)}
                  </Text>
                </View>
                <View style={styles.dayReviewCard}>
                  <Text style={styles.dayReviewTitle}>Day Close Payouts</Text>
                  <Text style={styles.meta}>
                    Lotto Payout: {dayClosePayouts?.lottoPayout != null ? `£ ${Number(dayClosePayouts.lottoPayout).toFixed(2)}` : "-"}
                  </Text>
                  <Text style={styles.meta}>
                    Scratch Card Payout: {dayClosePayouts?.scratchCardPayout != null ? `£ ${Number(dayClosePayouts.scratchCardPayout).toFixed(2)}` : "-"}
                  </Text>
                  <Text style={styles.meta}>
                    Till Payout: {dayClosePayouts?.tillPayout != null ? `£ ${Number(dayClosePayouts.tillPayout).toFixed(2)}` : "-"}
                  </Text>
                </View>
                <View style={styles.shiftListWrap}>
                  {(rows ?? []).map((row, index) => (
                    ...
                    >
                      ...
                      <Text style={styles.meta}>Sales: £ {Number(row.salesAmount).toFixed(2)}</Text>
                      <Text style={styles.meta}>Payout: £ {Number(row.prizePayout).toFixed(2)}</Text>
                      <Text style={styles.meta}>Expected: £ {Number(row.expectedCash).toFixed(2)}</Text>
                      <Text style={styles.meta}>Actual: £ {Number(row.actualCash).toFixed(2)}</Text>
                      <Text
                        style={[
                          styles.meta,
                      ...
                      >
                        Difference: £ {getDifferenceValue(row).toFixed(2)}
                      </Text>
                    </View>
                  ))}
                </View>
